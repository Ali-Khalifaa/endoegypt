...
@section('pageTitle',__('messages.teamGallery'))
@section('body')

@include('website.layouts.breadcrump', ['currentPage' => __('messages.teamGallery')])
...
@include('website.layouts.pagination',['model' => $teamGallery])
@endsection