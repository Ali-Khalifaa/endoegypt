                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6" v-if="data.ar" v-for="lang in languages">
                            ...
                            <Editor ref="descRef" v-model="v$[lang.code].description.$model"/>
                            <div class="invalid-feedback">
...
export default {
    ...
    setup(props){
       ...
       function resetModal() {
            ...
            setTimeout(async () => {
                if (props.type != 'edit') {
                    ...
                    adminApi.get(`dashboard/organizing-committee/${id.value}`)
                    .then((res) => {
                        loading.value = true;
                        let l = res.data.data;
       ...
       function resetModalHidden()
        ...
        return {t,id,
            loading,is_disabled,languages,handelEditor,descRef,
    ...
    methods: {
        ...
        if (this.type !== 'edit') {
            if (!this.v$.$error && this.numberOfImage) {
                ...
                this.loading = true;
                adminApi.post(`dashboard/organizing-committee`, formData)
                    .then((res) => {
                        Swal.fire({
                            icon: 'success',
            ...
            adminApi.post(`dashboard/organizing-committee/${this.id}`,formData)
                .then((res) => {
                    Swal.fire({
                        icon: 'success',
