...
//        'string' => 'لا يجب ان يكون طول حقل :attribute اكبر من :max حروفٍ/حرفًا.',
        'string' => 'حقل :attribute لا يجب أن يكون أكبر من :max أحرف.',
    ],
...
//        'string' => 'يجب أن يكون طول نص :attribute على الأقل :min حروفٍ/حرفًا',
    ...
    */
    ...
    'attributes' => [
        ...
        'translations.*.title' =>  'الاسم',
        'translations.*.description' =>  'الوصف',
        'business_id' =>  'رقم تعريف النشاط التجاري',
        'start_time' =>  'وقت البدايه',
        'end_time' =>  'وقت البدايه',
        'working_days' =>  'ايام العمل',
        "image" => 'صورة',
        "food_type_id" => 'أنواع الطعام',
        "kitchen_section_id" => 'أنواع المطابخ',
        "meal_category_id" => 'تصنيفات الأكلات',
        "message" => 'الرسالة',
        "birthday" => 'عيد ميلاد',
