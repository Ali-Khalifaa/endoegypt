...
use App\Models\TournamentInformation;
use Illuminate\Http\Request;
use Illuminate\Routing\Controllers\HasMiddleware;
use Illuminate\Routing\Controllers\Middleware;

class TournamentInformationController extends Controller implements HasMiddleware
{
    ...
    {
        $TournamentInformation = TournamentInformation::searchAndFilter()->latest()->paginate(10);
    ...
    {
        $TournamentInformation = TournamentInformation::with('translations')->findOrFail($id);
    ...
    public function update(TournamentInformationRequest $request,$id){
        $TournamentInformation = TournamentInformation::find($id);
